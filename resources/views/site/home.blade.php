                ...
                <div data-test="home">
                    ...
                    <div data-test="tcplusBanner" class="bg-black text-center text-white">
                        <div class="relative mx-auto max-w-[1600px] space-y-3 py-5 text-center">
                            ...
                            <div class="picture-container absolute right-[calc(100%_-_150px)] z-1 bottom-0 min-[1540px]:right-auto min-[1540px]:left-[30px] hidden md:block"
                                style="padding-bottom: 0; width: 276px; height: 304px">
                                <img class="picture-inner"
                                    ...
                                    srcset="
                            {{asset('assets/_next/static/images/phone-left-743e848adcec5270d0e95db71ddb17c5.png')}}?auto=format&amp;h=304&amp;w=276 1x,
                            {{asset('assets/_next/static/images/phone-left-743e848adcec5270d0e95db71ddb17c5.png')}}?auto=format&amp;h=608&amp;w=552 2x
                          "
                                    alt="" role="presentation" />
                            </div>
                            <div class="picture-container absolute left-[calc(100%_-_130px)] z-[3] origin-bottom scale-75 bottom-0 min-[1140px]:left-[calc(100%_-_170px)] min-[1540px]:left-auto min-[1540px]:right-[30px] min-[1540px]:scale-100 hidden md:block"
                                style="padding-bottom: 0; width: 285px; height: 414px">
                                <img class="picture-inner"
                                    src="{{asset('assets/_next/static/images/phone-right-a9d600ac9c6d63007f8358dc04d61dd2.png')}}?auto=format&amp;h=414&amp;w=285"
                                    srcset="
                            {{asset('assets/_next/static/images/phone-right-a9d600ac9c6d63007f8358dc04d61dd2.png')}}?auto=format&amp;h=414&amp;w=285 1x,
                            {{asset('assets/_next/static/images/phone-right-a9d600ac9c6d63007f8358dc04d61dd2.png')}}?auto=format&amp;h=828&amp;w=570 2x
                          "
                                    alt="" role="presentation" />
                            </div>
                        </div>
                    ...
                    <div class="container mt-2 px-0 md:px-3">
                        <div data-test="shopYourFavortieBrandSection"
                            ...
                            <div data-reach-tabs="" data-orientation="horizontal">
                                ...
                                <div class="pt-4" data-reach-tab-panels="">
                            ...
                            <div class="flex w-full flex-col justify-center pt-5 pb-3 lg:px-3" data-reach-tabs=""
                                    ...
                                    <div role="tablist" aria-orientation="horizontal"
                                        ...
                                        <button aria-controls="tabs--2--panel--0" aria-selected="true" role="tab"
                                            ...
                                            <span class="tab-text">Helpful links</span><span
                                                class="tab-bottom-border"></span></button><button
                                ...
                                <div class="border-y-[1px]" data-reach-tab-panels="">
                                    <div aria-labelledby="tabs--2--tab--0" role="tabpanel" tabindex="0"
                                        data-reach-tab-panel="" id="tabs--2--panel--0">
                                    ...
                                    <div aria-labelledby="tabs--2--tab--1" role="tabpanel" tabindex="-1"
                                        data-reach-tab-panel="" id="tabs--2--panel--1" hidden="">
                                        <div class="expandable-list-item">
                                            <button
                                                class="flex flex-nowrap justify-between expandable-list-item-button items-center"
                                                aria-expanded="false">
                                    ...
                                    <div aria-labelledby="tabs--2--tab--2" role="tabpanel" tabindex="-1"
                                        data-reach-tab-panel="" id="tabs--2--panel--2" hidden="">
                                        <div class="expandable-list-item">
                                            <button
                                                class="flex flex-nowrap justify-between expandable-list-item-button items-center"
                                                aria-expanded="false">
