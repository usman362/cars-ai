...
<script>
    $(document).ready(function() {
       ...
       $('button[role="tab"]').click(function(){
        let div = $(this).attr('aria-controls');
        $('div[aria-labelledby="'+div+'"]').removeAttr('hidden');
        $('div[aria-labelledby="'+div+'"]').next('div').attr('hidden');
        $('div[aria-labelledby="'+div+'"]').prev('div').attr('hidden');
       })
    });
